...
export default function ManagerDashboard() {
  return (
    <div>
      ...
      <div className="manager-stats-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
        ...
        <div className="stat-card">
          <div className="stat-title" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            Total Revenue
            <span style={{ color: '#059669', display: 'flex', alignItems: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>
              Rs.
            </span>
          </div>
          <div className="stat-value">Rs. 5,500,000.00</div>
      ...
      {/* Fleet Tracking Map & Table (Full Width) */}
      <div className="manager-table-container" style={{ width: '100%' }}>
